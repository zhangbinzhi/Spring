            ...
            DeleteAllHandler: function () {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status === "success") {
                                swal({ title: "删除成功!", type: "success", showConfirmButton: false, timer: 500 }, function () {
                                    location.reload();
                                });
                            } else {
                ...
                swal({
                    ...
                    if (tp === "增加") {
                        ...
                        $.ajax({
                            ...
                            type: "post",
                            dataType: 'json',//here
                            data: { table: p.postTable, "where": addWhere },
                            success: function (data) {
                                if (data.status === "success") {
                                    swal({ title: "保存成功!", type: "success", showConfirmButton: false, timer: 500 }, function () {
                                        location.reload();
                                    });
                                } else {
                        ...
                        $.ajax({
                            ...
                            type: "post",
                            dataType: 'json',
                            data: { table: p.postTable, "set": setVal, "where": where },
                            success: function (data) {
                                if (data.status === "success") {
                                    swal({ title: "保存成功!", type: "success", showConfirmButton: false, timer: 500 }, function () {
                                        location.reload();
